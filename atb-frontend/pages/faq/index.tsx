    ...
    return <Layout>
        <section className="relative py-16 bg-white min-w-screen animation-fade animation-delay">
            <div className="container px-0 px-8 mx-auto sm:px-12 xl:px-5">
                ...
                {
                    cards.map((c,i)=> <div className="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3" key={i}>
                        <h3 className="text-lg font-bold text-green-600 sm:text-xl md:text-2xl">
                            {c.q}
                        </h3>
